...
const Maintainer = ({ name, href }: { name: string; href: string }) => (
  <a
  ...
  >
    <svg
      className={styles.linkWithIconIcon}
      aria-hidden="true"
      focusable="false"
      viewBox="0 0 512 512"
    >
...
export const Header = memo(() => {
  ...
  return (
    <header className={styles.wrapper}>
      <h1 className={styles.extensionName}>
        <img src="./icons/icon.svg" alt="logo" className={styles.logoImage} />
        <p className={styles.logotype}>manaba Enhanced</p>
      </h1>
      ...
      <div className={styles.section}>
        <p className={styles.sectionHeading}>{versionNumber}</p>
        <a
          className={styles.linkWithIcon}
      ...
      <div className={styles.section}>
        ...
        <Maintainer
          name="Yuzuki Arai"
          href="https://twitter.com/yudukikun5120"
        />
      </div>
    </header>
  )
